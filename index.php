...
<html lang="pt-br">
	<head>
	    ...
	    <link href='support/nprogress.css' rel='stylesheet' />
	    ...
	    <script src="https://code.jquery.com/jquery-1.11.2.min.js"></script>
  		<script src='support/nprogress.js'></script>
	...
	<body>
		...
		?>
		<form method="POST" action="valida.php" enctype="multipart/form-data" class="contact2-form validate-form">
			...
			<div class="container-contact2-form-btn">
				<div class="wrap-contact2-form-btn">
					<div class="contact2-form-bgbtn"></div>
						<button type="submit" class="contact2-form-btn">Prosseguir
						</button>
				</div>
			</div>
		</form>
